...
import com.example.book_storemanagement.model.entity.Roles;
...
public class UsersPrinciple implements UserDetails {
    ...
    public static UsersPrinciple build(Account account) {
        List<GrantedAuthority> authorities = new ArrayList<>();
        for (Roles roles : account.getRoles()) {
            authorities.add(new SimpleGrantedAuthority(roles.getName()));
        }
        return new UsersPrinciple(account.getUsername(),
